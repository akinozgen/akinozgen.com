...
- **Çaylar Belediyeden** (`belediye`) — a card game in Turkish: you run a
  made-up Anatolian town by swiping memos left or right. Plain JS, no
  dependencies; see [apps/belediye/README.md](apps/belediye/README.md).
...
| `apps/belediye`  | Çaylar Belediyeden — plain JS, built by its own `build.mjs`           |
