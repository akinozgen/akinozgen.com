...
const js = ["cards.js", "engine.js", "portrait.js", "ui.js"].map(f => read("src/" + f)).join("\n\n");
...
const fill = (t, standalone, vendor) => t.replace("<!--VENDOR-->", () => VENDOR[vendor]).replace("<script>/*SCRIPT*/</script>", () => script(standalone));
...
const assets = ["./", "index.html", "manifest.webmanifest", "vendor/interact.min.js",
  ...
  ...readdirSync(new URL("icons/", W)).map(f => "icons/" + f)];
