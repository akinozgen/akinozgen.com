...
- Başkanın isteği üzerine gizli bir hile eklendi. Seçim gecesi ekranında klavyeden "akparti" yazılınca (büyük/küçük harf, ı/i fark etmez) elektrikler kesilir. Işıklar gelince "trafoya bir kedi girmiştir", Tekir olay yerinden uzaklaşırken görülür ve sandıklar baştan, sizin lehinize sayılır. Hileli sonuç kayda işlenir, gece başına bir kez çalışır, "Neden?" listesinde de görünür. Kod yalnız kaynakta durur, ekranda parti adı geçmez. README'ye yazılmadı, sürpriz kalsın. `pnpm election` bunu da sınıyor.
