...
const chrome = spawn(process.env.CHROME || "C:/Program Files/Google/Chrome/Application/chrome.exe", ["--headless=new", "--mute-audio", "--disable-gpu", "--hide-scrollbars", "--remote-debugging-port=9338", `--user-data-dir=${OUT}/prof`, "--no-first-run", "about:blank"], { stdio: "ignore" });
...
try {
  ...
  for (const [w, h] of [[360, 640], [390, 664], [412, 780], [430, 860]]) {
