...
Kurgusal Karakavak ilçesinin belediye başkanı sizsiniz. Her ay masanıza bir evrak gelir; siz onu sağa ya da sola kaydırırsınız. Halkı, kasayı, esnafı ve Ankara'yı dengede tutmanız gerekir. Kasa ya da Ankara dibe vurursa da tavan yaparsa da makam gider; esnaf dibe vurursa gider, tavan yaparsa erken seçim olur. Halk ise yalnız dibe vurursa tehlikelidir; sevgisi fazla gelmez, sandıkta işe yarar. Seçim beş yılda bir yapılır.
...
| `pnpm election` | Headless Chrome'da seçim gecesi testi: 5 adaylı yarış kurar, sayım sonucunu motorla karşılaştırır, "Kaldığım yerden"i dener |
