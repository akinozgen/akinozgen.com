...
| Yol | İçerik |
|---|---|
| `src/cards.js` | 32 karakter, ~150 evrak, kriz kartları, 10 son |
| `src/engine.js` | DOM'suz oyun motoru. Denge ayarları `TUNE` nesnesinde |
| `src/portrait.js` | Tariften SVG vesikalık üreteci |
...
| `web-src/` | Yerel fontlar (SIL OFL), ikonlar, interact.js (MIT) |
