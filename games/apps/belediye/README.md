...
| `pnpm kampanya` | Headless Chrome'da seçim beyannamesi testi: telefonda ve masaüstünde altı söz, üç söz sınırı, motorla aynı kampanya anketi, Geri/Escape. Sandık yolu iki tur denenir: seçim gecesi aday etiketiyle açılır, açılış evrakı, başlangıç göstergeleri, sözler ve takvim doğrulanır. Sessiz kampanya da denenir |
...
- **Göreve başlayış:** Aday kaydından sonra seçim beyannamesi gelir. Her oyunda 20 vaatlik havuzdan (`VAATLER`) altısı çıkar, en çok üçü seçilir. Sessiz kampanya seçimsiz ve düşük başlar (halk 44). Sandığa giden seçim gecesini izler. Rahat kazanma şansı %40 artı sözlerin gücüdür, en çok %80. Rahat zafer yüksek başlatır: halk 62, bir fazla danışma hakkı, defterde "Sandıktan güçlü çıkış" +3. Kıl payı zafer sessizden de düşük başlatır (halk 36, Nermin kırgın). Her söz tutulana kadar ankette ödenir ve ilk dönemde hesap evrakıyla geri gelir. Tutulursa defterde artı, geçiştirilirse eksi yazılır; iki durumda da söz kapanır. `pnpm sim` varsayılan olarak oyunların yarısını sessiz, yarısını üç sözle sandıktan başlatır; `acilis=sessiz|zafer|kilpayi|kumar|eski` tek türü ölçer.
