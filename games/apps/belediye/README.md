...
Kurgusal Karakavak ilçesinin belediye başkanı sizsiniz. Her ay masanıza bir evrak gelir; siz onu sağa ya da sola kaydırırsınız. Halkı, kasayı, esnafı ve Ankara'yı dengede tutmanız gerekir. Dibe vuran gösterge makamı götürür. Tavan oyunu bitirmez ama bedelsiz de değildir: çarşı sultası, Ankara'nın gözdesi, kasa fazlası. Halkın sevgisi fazla gelmez, sandıkta işe yarar. Seçim beş yılda bir yapılır.
...
- **Tavan hâlleri:** Çok sevilmek ve çok para oyunu bitirmez, bedel dönemi başlatır (`TAVAN`, `TALEP`; ayarlar `TUNE`'da). Esnaf ve Ankara doyar: 80'in üstüne taşan artı yarım işler, 85 ve üstünde düşüş 1,3 kat sert olur. Gösterge 85'i geçince hâl başlar, 75'in altına inince biter. Hâl "Yürürlükte" şeridinde görünür ve yer sınırına sayılmaz. Hâldeyken 8 ayda bir, %35 olasılıkla talep evrakı gelir; her biri bir kez. Karşılamak o grubu tutar ama halka ve kasaya patlar, reddetmek sert düşürür.
  - **Çarşı sultası (esnaf):** her ay halk −1. Üç kez boyun eğen başkana kıyak dosyası açılır (`kayirma_1/2`). Dosyayı kapatmak kurtarır, iki kez sahip çıkmak kazanılmış ceza sonu getirir (`kayirma`).
  - **Ankara'nın gözdesi:** her ay halk −1, Suat Bey kıskanır.
  - **Kasa fazlası:** her ay kasa −2; sendika, müteahhit ve çarşı pay ister. Eski müfettiş sonu (`k100`) yalnız duvardaki eski oyunlar için duruyor.
  - Eskiden esnaf 100 erken seçim açıyordu, sonra kısa bir süre oda teklifi getirdi. İkisi de kaldırıldı: bekleyen eski kayıtların beklemesi düşer, eski `e100` sonu duvarda durur.
...
- **Ankara'dan davet:** Ankara'nın gözdesine liste zamanında gelir: seçimden 12-10 ay önce, dönemde bir kez. Ankara en az 80 olmalı ve en az iki Ankara ricası karşılanmış olmalı (`DAVET`). Teklif her retle büyür: genel merkez, milletvekilliği, sonra hep bakan yardımcılığı. Kabul oyunu hemen bitirmez, önce bir veda evrakı gelir (`veda_*`). Orada gitmek terfi finalidir, gazete "MÜJDE" diye çıkar; kalmak Ankara'yı küstürür. Ret halkı sevindirir, Ankara'yı sert düşürür ve peşine evrak getirir: manşet, genel merkezin kırgınlığı, geciken ödenek, Suat Bey'in vefa borcu, "rutin" denetim.
